...
- Supabase Security Advisor reports zero errors and zero warnings. Ten informational RLS items are deliberately policy-less internal/worker tables and therefore fail closed.
