...
| 5   | A contribution is identifiable from an aggregate   | Real-world consequences for the contributor                                          | Per-metric thresholds, 24-hour lag, shape suppression wired into the salary worker                                            | Low for salary; **Medium for review, interview, benefit and pay-reliability workers**        |
