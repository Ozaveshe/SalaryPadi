...
| Career-data associate              | Partial — protected field-by-field duplicate decisions are reachable | No searchable job detail view or operator intake                    |
...
searchable operator job-detail views and operator intake. Duplicate candidates
now have a protected field-by-field comparison; that narrower criterion is met.
