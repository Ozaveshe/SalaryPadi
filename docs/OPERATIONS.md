...
| `ats_source_sync`        | `ats-source-sync`        | :02, :17, :32, :47         | Safe disabled skip, or claimed source plus append-only snapshot counts     | Set the environment gate false; pause any affected source/configuration       |
